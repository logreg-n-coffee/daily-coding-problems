...
// 1. Two linked lists have the same length - move the pointer all the way to the end until it reaches the end
// 2. Two linked lists do not have the same length - put t
